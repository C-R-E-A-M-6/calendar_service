...
const createReservations = require('../PostgreSQL/createReservations.js');

const writeReservations = fs.createWriteStream('cassandra_reservations10.csv');
